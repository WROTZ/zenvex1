  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
      <section className="glass-card p-8 sm:p-10">
        <Link className="inline-flex items-center gap-2 text-sm text-slate-400 transition hover:text-primary" to="/challenges">
          <ArrowLeft size={16} />
          Back to challenges
        </Link>
        ...
        <div className="mt-8 grid gap-4">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-2 text-sm text-slate-400">${challenge.accountSize.toLocaleString()} account size</p>
          </div>
      ...
      <section className="glass-card p-8 sm:p-10">
        ...
        <div className="mt-8 space-y-4">
          ...
          <div className="flex items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-4 py-4">
            <span className="text-sm text-slate-300">Challenge fee</span>
        ...
        <p className="mt-4 text-sm leading-7 text-slate-400">
          {functions
            ? "On successful payment, Zenvex Capital saves your order in Firestore and redirects you to a confirmation page with your generated order ID."
            : "In demo mode, Zenvex Capital stores a local sample order and dashboard snapshot so the client can review the funded flow without live credentials."}
        </p>
      </section>
    </div>
  );
